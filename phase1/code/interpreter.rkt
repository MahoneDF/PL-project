...
(convert-parser-output '(program (fundec (fun-dcl int main () (compound-stmnt ((var-spec int a) (a = 5) (if ((a) > 3) (compound-stmnt ((return ((a) + 2)))) else (compound-stmnt ((return ((a) - 4)))))))))))
(run '(program (fundec (fun-dcl int main () (compound-stmnt ((var-spec int a) (a = 5) (if ((a) > 6) (compound-stmnt ((return ((a) + 2)))) else (compound-stmnt ((return ((a) - 4)))))))))))
(convert-parser-output '(program (fundec (fun-dcl int main () (compound-stmnt ((var-spec int a) (a = 5) (var-spec int i) (i = 4) (while ((i) > 0) (compound-stmnt ((a = (* (a) 2))))) (return (a))))))))
; (run '(program (fundec (fun-dcl int main () (compound-stmnt ((var-spec int a) (a = 5) (var-spec int i) (i = 4) (while ((i) > 0) (compound-stmnt ((a = (* (a) 2))))) (return (a))))))))
(convert-parser-output '(program (fundec (fun-dcl int g (param-list ((argvar int x))) (compound-stmnt ((return ((x) + 1))))) (fundec (fun-dcl int main () (compound-stmnt ((var-spec int a) (a = 5) (return (a)))))))))
(run '(program (fundec (fun-dcl int g (param-list ((argvar int x))) (compound-stmnt ((return ((x) + 1))))) (fundec (fun-dcl int main () (compound-stmnt ((var-spec int a) (a = 5) (return (a)))))))))
(convert-parser-output '(program (fundec (fun-dcl int g (param-list ((argvar int x))) (compound-stmnt ((return ((x) + 1))))) (fundec (fun-dcl int main () (compound-stmnt ((var-spec int a) (a = 5) (return (call (g ((a))))))))))))
(run '(program (fundec (fun-dcl int g (param-list ((argvar int x))) (compound-stmnt ((return ((x) + 5))))) (fundec (fun-dcl int main () (compound-stmnt ((var-spec int a) (a = 5) (return (call (g ((a))))))))))))
(convert-parser-output '(program (fundec (fun-dcl int g (param-list ((argvar int x))) (compound-stmnt ((return (* (x) 2))))) (fundec (fun-dcl int main () (compound-stmnt ((var-spec int a) (a = 5) (return (call (g ((a))))))))))))
(run '(program (fundec (fun-dcl int g (param-list ((argvar int x))) (compound-stmnt ((return (* (x) 6))))) (fundec (fun-dcl int main () (compound-stmnt ((var-spec int a) (a = 5) (return (call (g ((a))))))))))))